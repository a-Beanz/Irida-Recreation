...
function onDiscordPresenceUpdate(e) {
	...
	if(data.button1Label == null)
		data.button1Label = "Jeffy's Infinite Irida";
...
function onMenuLoaded(name:String) {
	// Name is either "Irida Menu", "Freeplay", "Title Screen", "Options Menu", "Credits Menu", "Beta Warning", "Update Available Screen", "Update Screen"
